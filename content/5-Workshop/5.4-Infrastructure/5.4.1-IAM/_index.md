...
<p align="center"><i>Figure 5.9. The `token.actions.githubusercontent.com` GitHub OIDC provider uses OpenID Connect with `sts.amazonaws.com` as its audience. The repository and branch restrictions are documented in the trust-policy code above.</i></p>

![LearnSphere IAM roles](/images/learnsphere-iam-roles.png)

<p align="center"><i>Figure 5.10. IAM roles are separated by function: `LearnSphereGitHubDeployRole2` supports CI/CD, while `LearnSphereEc2Role2` is assumed by the Backend EC2 instances.</i></p>
