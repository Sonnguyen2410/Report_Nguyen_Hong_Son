...
<p align="center"><i>Hình 5.11. Hai bucket `learnsphere-fe-2` và `learnsphere-media-2` được tạo tại AWS Region Singapore (`ap-southeast-1`) để tách riêng bản build Frontend và học liệu của hệ thống.</i></p>

![Danh sách Docker image trong Amazon ECR](/images/learnsphere-ecr-images.png)

<p align="center"><i>Hình 5.12. Repository `learnsphere-be-2` lưu các Docker image Backend với tag là Git commit SHA, cho phép truy vết chính xác source code tương ứng với từng phiên bản đã phát hành.</i></p>
