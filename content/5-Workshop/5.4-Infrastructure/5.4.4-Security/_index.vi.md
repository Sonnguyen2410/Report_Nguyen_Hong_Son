...
<p align="center"><i>Hình 5.16. `LearnSphere-ALB-SG` thuộc production VPC và chỉ có một inbound rule HTTPS port 443. ALB không mở trực tiếp port ứng dụng 5000.</i></p>

![Inbound rule của Backend Security Group](/images/learnsphere-backend-security-group.png)

<p align="center"><i>Hình 5.17. `LearnSphere-Backend-SG` chỉ cho phép TCP port 5000 từ Security Group `LearnSphere-ALB-SG` (`sg-0f2fe594908268fc3`), thay vì mở port Backend cho toàn bộ Internet.</i></p>

![Thông tin mạng của Backend EC2 private](/images/learnsphere-private-ec2-network.png)

<p align="center"><i>Hình 5.18. Backend EC2 nằm trong private subnet tại `ap-southeast-1b`, có private IPv4 `10.20.153.245` nhưng không có public IPv4, public DNS hoặc IPv6 public.</i></p>
