...
<p align="center"><i>Hình 5.22. `LearnSphere-Backend-LT` sử dụng version 2 làm mặc định, Amazon Linux AMI `ami-01b70d44184a858e8`, instance type `t3.small` và Backend Security Group `sg-0cae310ddce032bbf`. Toàn bộ User Data được chủ động loại khỏi ảnh vì cấu hình vận hành không được làm lộ dữ liệu nhạy cảm.</i></p>
