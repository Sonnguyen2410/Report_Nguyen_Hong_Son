...
<p align="center"><i>Hình 5.41. Backend job hoàn tất kiểm thử, xác thực AWS bằng OIDC, đăng nhập ECR, build và push Docker image, sau đó rollout qua Auto Scaling Group.</i></p>

![Các Docker image bất biến được lưu trong Amazon ECR](/images/learnsphere-cicd-ecr-images.png)

<p align="center"><i>Hình 5.42. Repository `learnsphere-be-2` lưu các image được gắn tag theo commit SHA, hỗ trợ truy vết release và rollback về artifact trước đó.</i></p>
