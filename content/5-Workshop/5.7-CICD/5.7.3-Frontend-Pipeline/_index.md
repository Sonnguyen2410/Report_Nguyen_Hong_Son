...
<p align="center"><i>Figure 5.43. The frontend job completes dependency installation, production bundle creation, S3 synchronization, and CloudFront invalidation.</i></p>

![CloudFront invalidations following frontend pipeline releases](/images/learnsphere-cicd-cloudfront-invalidations.png)

<p align="center"><i>Figure 5.44. CloudFront records the invalidations as `Completed`, confirming that edge caches were refreshed after frontend releases.</i></p>
