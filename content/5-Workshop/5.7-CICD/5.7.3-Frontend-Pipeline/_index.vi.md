...
<p align="center"><i>Hình 5.43. Frontend job hoàn tất cài dependency, build production bundle, đồng bộ nội dung lên S3 và tạo CloudFront invalidation.</i></p>

![Các CloudFront invalidation sau khi pipeline phát hành Frontend](/images/learnsphere-cicd-cloudfront-invalidations.png)

<p align="center"><i>Hình 5.44. CloudFront ghi nhận các invalidation ở trạng thái `Completed`, xác nhận edge cache đã được làm mới sau các lần phát hành Frontend.</i></p>
