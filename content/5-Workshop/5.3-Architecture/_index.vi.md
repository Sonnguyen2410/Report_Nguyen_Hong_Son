...
<p align="center"><i>Hình 5.6. Kiến trúc As-Built của LearnSphere sau khi nâng cấp Backend theo mô hình High Availability Multi-AZ.</i></p>
...
<p align="center"><i>Hình 5.7. VPC Resource Map thể hiện bốn subnet trên hai Availability Zone, các route table, Internet Gateway, hai NAT Gateway và S3 Gateway Endpoint của LearnSphere.</i></p>
...
<p align="center"><i>Hình 5.8. Target Group của Application Load Balancer ghi nhận hai Backend target healthy trên port 5000 và không có target unhealthy.</i></p>
