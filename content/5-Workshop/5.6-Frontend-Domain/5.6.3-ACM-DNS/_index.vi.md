...
<p align="center"><i>Hình 5.33. Chứng chỉ ACM cho `www.learnspherev2.id.vn` tại `us-east-1` đã ở trạng thái `Issued` và xác thực tên miền thành công.</i></p>

![Chứng chỉ ACM cho ALB origin được phát hành tại ap-southeast-1](/images/learnsphere-acm-alb-certificate.png)

<p align="center"><i>Hình 5.34. Chứng chỉ ACM cho `origin.learnspherev2.id.vn` tại `ap-southeast-1` đã ở trạng thái `Issued` và sẵn sàng cho listener HTTPS của ALB.</i></p>

![Các bản ghi CNAME traffic và ACM validation tại TenTen](/images/learnsphere-tenten-dns-records.png)

<p align="center"><i>Hình 5.35. DNS TenTen định tuyến `www` đến CloudFront, `origin` đến ALB và duy trì hai CNAME validation để ACM tự động gia hạn chứng chỉ.</i></p>
