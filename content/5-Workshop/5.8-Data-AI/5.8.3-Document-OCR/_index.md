...
<p align="center"><i>Figure 5.51: The tutor lesson page reports that the document has been read and is ready for AI operations. The same panel keeps the original learning document available to authorized users.</i></p>
...
<p align="center"><i>Figure 5.52: Processed learning content is rendered with readable Vietnamese text and chemical subscripts. The sample confirms that the extraction and presentation pipeline preserves meaningful instructional notation without exposing personal data.</i></p>
