...
1. Mở **AWS Management Console** $\rightarrow$ dịch vụ **Amazon ECR** $\rightarrow$ chọn **Private repositories**.
...
1. Mở Repository `learnsphere-be` $\rightarrow$ chọn mục **Lifecycle policies** bên menu trái $\rightarrow$ chọn **Create rule**.
2. **Rule priority:** `1`.
