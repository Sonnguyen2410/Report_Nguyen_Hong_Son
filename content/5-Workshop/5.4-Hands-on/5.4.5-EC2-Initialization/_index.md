...
1. Open **AWS Management Console** $\rightarrow$ navigate to **Amazon EC2** $\rightarrow$ click **Launch instance**.
...
Connect to EC2 via **AWS SSM Session Manager** (Click **Connect** $\rightarrow$ **Session Manager**), then run the setup script:
